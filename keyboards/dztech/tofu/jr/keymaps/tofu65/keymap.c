...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_TAB_HOLD_ONE_OSL] = LAYOUT_65_ansi(
        HYPR(KC_ESC), HYPR(KC_1), HYPR(KC_2), HYPR(KC_3), HYPR(KC_4), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        ...
        HYPR(KC_BACKSLASH), HYPR(KC_S), HYPR(KC_D), HYPR(KC_F), _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
        HYPR(KC_LSFT), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
        _______, _______, _______,                            _______,          _______, _______, _______,          _______, _______, _______
    ),
